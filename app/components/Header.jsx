...
export default function Header() {
  return (
    <header className="flex gap-5 justify-evenly w-full max-md:flex-row max-md:max-w-full bg-gray-50 shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
      ...
      <nav className="md:hidden flex gap-5 justify-between items-center py-5 my-auto text-base font-medium whitespace-nowrap text-zinc-900 max-md:flex-wrap max-md:max-w-full">
      ...
      <nav className="md:flex hidden gap-5 justify-between items-center py-5 my-auto text-base font-medium whitespace-nowrap text-zinc-900 max-md:flex-wrap max-md:max-w-full">
        ...
        <a href="/staff" className="text-lg">
          faculty and staff
        </a>
        <CiSearch size={"25"} />
      </nav>
